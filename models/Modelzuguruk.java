...
public static class Modelzuguruk extends EntityModel {
	...
	public Modelzuguruk() {
		...
		head.cubeList.add(new ModelBox(head, 1, 59, -5.0F, -3.4F, -1.6F, 3, 1, 1, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 1, 59, 2.0F, -3.4F, -1.6F, 3, 1, 1, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 22, 45, -3.0F, 1.6F, -0.6F, 1, 4, 1, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 22, 45, 2.0F, 1.6F, -0.6F, 1, 4, 1, 0.0F, false));
