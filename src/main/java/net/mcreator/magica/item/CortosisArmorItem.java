...
public class CortosisArmorItem extends MagicaModElements.ModElement {
	@ObjectHolder("magica:cortosis_armorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("magica:cortosis_armorbody")
	public static final Item body = null;
	@ObjectHolder("magica:cortosis_armorlegs")
	public static final Item legs = null;
	@ObjectHolder("magica:cortosis_armorboots")
	...
	public void initElements() {
		...
		}.setRegistryName("cortosis_armorhelmet"));
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(ItemGroup.COMBAT)) {
			@Override
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "magica:textures/models/armor/cortosis_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("cortosis_armorbody"));
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.LEGS, new Item.Properties().group(ItemGroup.COMBAT)) {
			@Override
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "magica:textures/models/armor/cortosis_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("cortosis_armorlegs"));
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.FEET, new Item.Properties().group(ItemGroup.COMBAT)) {
			@Override
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "magica:textures/models/armor/cortosis_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("cortosis_armorboots"));
	}
}
