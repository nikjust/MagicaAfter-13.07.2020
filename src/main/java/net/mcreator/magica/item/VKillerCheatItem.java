...
import net.mcreator.magica.procedures.VKillerCheatWhileBulletFlyingTickProcedure;
import net.mcreator.magica.procedures.VKillerCheatBulletHitsBlockProcedure;
...
public class VKillerCheatItem extends MagicaModElements.ModElement {
	@ObjectHolder("magica:v_killer_cheat")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletv_killer_cheat").setRegistryName("entitybulletv_killer_cheat"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("v_killer_cheat");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void tick() {
			...
			Entity entity = this.getShooter();
			{
				...
				VKillerCheatWhileBulletFlyingTickProcedure.executeProcedure($_dependencies);
			}
			if (this.inGround) {
				{
					Map<String, Object> $_dependencies = new HashMap<>();
					...
					$_dependencies.put("z", z);
					$_dependencies.put("world", world);
					VKillerCheatBulletHitsBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
