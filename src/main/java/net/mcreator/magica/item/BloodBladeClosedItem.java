...
import net.mcreator.magica.procedures.BloodBladeClosedRightClickedOnBlockProcedure;
...
public class BloodBladeClosedItem extends MagicaModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("blood_blade_closed");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			double z = entity.posZ;
			{
				...
				BloodBladeClosedRightClickedOnBlockProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
