...
import net.mcreator.magica.procedures.BlockAnalyserRightClickedOnBlockProcedure;
...
public class BlockAnalyserItem extends MagicaModElements.ModElement {
	@ObjectHolder("magica:block_analyser")
	public static final Item block = null;
	@ObjectHolder("magica:entitybulletblock_analyser")
	public static final EntityType arrow = null;
	public BlockAnalyserItem(MagicaModElements instance) {
		super(instance, 331);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletblock_analyser").setRegistryName("entitybulletblock_analyser"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("block_analyser");
		}
		...
		public void onUsingTick(ItemStack itemstack, LivingEntity entityLiving, int count) {
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 100f, 0, 0);
			...
			if (this.inGround) {
				{
					...
					BlockAnalyserRightClickedOnBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
