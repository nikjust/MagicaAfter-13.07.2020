...
public class MagicExoSkeletonLegsItem extends MagicaModElements.ModElement {
	@ObjectHolder("magica:magic_exo_skeleton_legs_helmet")
	public static final Item helmet = null;
	@ObjectHolder("magica:magic_exo_skeleton_legs_chestplate")
	public static final Item body = null;
	@ObjectHolder("magica:magic_exo_skeleton_legs_leggings")
	public static final Item legs = null;
	@ObjectHolder("magica:magic_exo_skeleton_legs_boots")
	public static final Item boots = null;
	public MagicExoSkeletonLegsItem(MagicaModElements instance) {
		super(instance, 108);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public String getName() {
				return "magic_exo_skeleton_legs";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.LEGS, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "magica:textures/fffmagic.png";
			}
		}.setRegistryName("magic_exo_skeleton_legs_leggings"));
	}
