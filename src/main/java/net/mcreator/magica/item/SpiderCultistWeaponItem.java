...
import net.mcreator.magica.procedures.SpiderCultistWeaponBulletHitsPlayerProcedure;
import net.mcreator.magica.procedures.SpiderCultistWeaponBulletHitsBlockProcedure;
...
public class SpiderCultistWeaponItem extends MagicaModElements.ModElement {
	@ObjectHolder("magica:spider_cultist_weapon")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletspider_cultist_weapon").setRegistryName("entitybulletspider_cultist_weapon"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("spider_cultist_weapon");
		}

		@Override
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			super.addInformation(itemstack, world, list, flag);
			list.add(new StringTextComponent("Cheeeater"));
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			World world = this.world;
			{
				...
				SpiderCultistWeaponBulletHitsPlayerProcedure.executeProcedure($_dependencies);
			}
		}
			...
			if (this.inGround) {
				{
					...
					$_dependencies.put("z", z);
					$_dependencies.put("world", world);
					SpiderCultistWeaponBulletHitsBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
