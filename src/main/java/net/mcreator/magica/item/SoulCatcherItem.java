...
import net.mcreator.magica.procedures.SoulCatcherWhileBulletFlyingTickProcedure;
import net.mcreator.magica.procedures.SoulCatcherBulletHitsLivingEntityProcedure;
...
public class SoulCatcherItem extends MagicaModElements.ModElement {
	@ObjectHolder("magica:soul_catcher")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletsoul_catcher").setRegistryName("entitybulletsoul_catcher"));
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				...
				SoulCatcherBulletHitsLivingEntityProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void tick() {
			...
			Entity entity = this.getShooter();
			{
				...
				SoulCatcherWhileBulletFlyingTickProcedure.executeProcedure($_dependencies);
			}
			if (this.inGround) {
				this.remove();
			}
