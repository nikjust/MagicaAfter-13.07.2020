...
import net.mcreator.magica.procedures.CosmoportUnpackerBulletHitsBlockProcedure;
...
public class CosmoportUnpackerItem extends MagicaModElements.ModElement {
	@ObjectHolder("magica:cosmoport_unpacker")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletcosmoport_unpacker").setRegistryName("entitybulletcosmoport_unpacker"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("cosmoport_unpacker");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ItemStack stack = ShootableItem.getHeldAmmo(entity,
							e -> e.getItem() == new ItemStack(CosmoportUnpackerItem.block, (int) (1)).getItem());
					if (stack == ItemStack.EMPTY) {
						for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
							ItemStack teststack = entity.inventory.mainInventory.get(i);
							if (teststack != null && teststack.getItem() == new ItemStack(CosmoportUnpackerItem.block, (int) (1)).getItem()) {
								stack = teststack;
								break;
							}
						}
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						...
						if (entity.abilities.isCreativeMode) {
							...
							if (new ItemStack(CosmoportUnpackerItem.block, (int) (1)).isDamageable()) {
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(CosmoportUnpackerItem.block, (int) (1));
		}
			...
			if (this.inGround) {
				{
					...
					CosmoportUnpackerBulletHitsBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
