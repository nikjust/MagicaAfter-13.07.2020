...
import net.mcreator.magica.procedures.RicoLightBulletRangedItemUsedProcedure;
import net.mcreator.magica.procedures.RicoLightBulletBulletHitsLivingEntityProcedure;
...
public class RicoLightBulletItem extends MagicaModElements.ModElement {
	@ObjectHolder("magica:rico_light_bullet")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletrico_light_bullet").setRegistryName("entitybulletrico_light_bullet"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("rico_light_bullet");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.DISALLOWED;
					{
						...
						RicoLightBulletRangedItemUsedProcedure.executeProcedure($_dependencies);
					}
				}
			}
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			World world = this.world;
			{
				...
				RicoLightBulletBulletHitsLivingEntityProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("magica:textures/bulletricochet.png");
