...
import net.mcreator.magica.procedures.EndermanCultistMagicBulletHitsPlayerProcedure;
...
public class EndermanCultistMagicItem extends MagicaModElements.ModElement {
	@ObjectHolder("magica:enderman_cultist_magic")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletenderman_cultist_magic").setRegistryName("entitybulletenderman_cultist_magic"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("enderman_cultist_magic");
		}

		@Override
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			super.addInformation(itemstack, world, list, flag);
			list.add(new StringTextComponent("Cheeeeeeater!!!"));
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			World world = this.world;
			{
				...
				EndermanCultistMagicBulletHitsPlayerProcedure.executeProcedure($_dependencies);
			}
		}
