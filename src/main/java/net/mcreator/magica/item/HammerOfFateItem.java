...
import net.mcreator.magica.procedures.BoofProcedure;
...
public class HammerOfFateItem extends MagicaModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			double z = entity.posZ;
			{
				...
				BoofProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
