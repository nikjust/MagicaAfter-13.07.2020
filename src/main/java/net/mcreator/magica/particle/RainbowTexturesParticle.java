...
package net.mcreator.magica.particle;
...
public class RainbowTexturesParticle extends MagicaModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public RainbowTexturesParticle(MagicaModElements instance) {
		super(instance, 332);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("rainbow_textures"));
	}
