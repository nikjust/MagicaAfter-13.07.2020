...
import net.mcreator.magica.procedures.SlugThisEntityKillsAnotherOneProcedure;
...
public class SlugEntity extends MagicaModElements.ModElement {
	public static EntityType entity = null;
	public SlugEntity(MagicaModElements instance) {
		super(instance, 461);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f)).build("slug")
						.setRegistryName("slug");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -60, -181, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("slug_spawn_egg"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(CustomEntity.class, renderManager -> {
			return new MobRenderer(renderManager, new Modelslug(), 0.5f) {
				{
					this.addLayer(new GlowingLayer<>(this));
				}
				@Override
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("magica:textures/slug.png");
				}
			};
		});
	}
	public static class CustomEntity extends MonsterEntity {
		...
		public void onKillEntity(LivingEntity entity) {
			...
			Entity sourceentity = this;
			{
				...
				SlugThisEntityKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		private static final ResourceLocation GLOW_TEXTURE = new ResourceLocation("magica:textures/slug.png");
