...
public class VillagerLOLEntity extends MagicaModElements.ModElement {
	public static EntityType entity = null;
	public VillagerLOLEntity(MagicaModElements instance) {
		super(instance, 122);
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Magica Villager");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new MagicaVillagerGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
