...
public class MageEntity extends MagicaModElements.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(CustomEntity.class, renderManager -> {
			return new MobRenderer(renderManager, new ModelsteveEvoker(), 0.5f) {
				@Override
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("magica:textures/mage.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new LookAtGoal(this, MonsterEntity.class, (float) 6));
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				MageOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
