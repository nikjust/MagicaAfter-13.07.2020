...
public class ExilSlimeEntity extends MagicaModElements.ModElement {
	public static EntityType entity = null;
	public ExilSlimeEntity(MagicaModElements instance) {
		super(instance, 427);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 1f)).build("exil_slime")
						.setRegistryName("exil_slime");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("exil_slime_spawn_egg"));
	}
