...
public class VoidAvatarStage2Entity extends MagicaModElements.ModElement {
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(3f, 3f)).build("void_avatar_stage_2")
						.setRegistryName("void_avatar_stage_2");
		elements.entities.add(() -> entity);
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
				.size(0.5f, 0.5f)).build("entitybulletvoid_avatar_stage_2").setRegistryName("entitybulletvoid_avatar_stage_2"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(CustomEntity.class, renderManager -> {
			return new MobRenderer(renderManager, new ModelVoidAvatarstage2(), 3f) {
				{
	...
	public static class ModelVoidAvatarstage2 extends EntityModel {
		...
		public ModelVoidAvatarstage2() {
			...
			Layer0.cubeList.add(new ModelBox(Layer0, 0, 0, -6.0F, -20.0F, -34.6667F, 12, 12, 12, 0.0F, false));
			...
			Layer0.cubeList.add(new ModelBox(Layer0, 0, 0, 8.0F, -6.0F, -21.6667F, 12, 12, 12, 0.0F, false));
			...
			Layer1.cubeList.add(new ModelBox(Layer1, 0, 0, 22.0F, -6.0F, -5.6667F, 12, 12, 12, 0.0F, false));
			Layer1.cubeList.add(new ModelBox(Layer1, 0, 0, -6.0F, -6.0F, 22.3333F, 12, 12, 12, 0.0F, false));
			...
			Layer2.cubeList.add(new ModelBox(Layer2, 0, 0, -20.0F, -53.0F, -20.6667F, 12, 12, 12, 0.0F, false));
			...
			Layer2.cubeList.add(new ModelBox(Layer2, 0, 0, -20.0F, -53.0F, 8.3333F, 12, 12, 12, 0.0F, false));
			Layer2.cubeList.add(new ModelBox(Layer2, 0, 0, -20.0F, -6.0F, -5.6667F, 12, 12, 12, 0.0F, false));
			Layer2.cubeList.add(new ModelBox(Layer2, 0, 0, 36.0F, 8.0F, -5.6667F, 12, 12, 12, 0.0F, false));
