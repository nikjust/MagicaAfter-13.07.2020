...
import net.mcreator.magica.procedures.MarionetteRightClickedOnEntityProcedure;
...
public class MarionetteEntity extends MagicaModElements.ModElement {
	public static EntityType entity = null;
	public MarionetteEntity(MagicaModElements instance) {
		super(instance, 451);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("marionette")
						.setRegistryName("marionette");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -10066432, -6711040, new Item.Properties().group(MagicaItemGroup.tab))
				.setRegistryName("marionette_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(CustomEntity.class, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(), 0.5f) {
				...
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("magica:textures/zombie.png");
				}
			};
	...
	public static class CustomEntity extends TameableEntity {
		...
		public boolean processInteract(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				MarionetteRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
