...
public class BwtreeStructure extends MagicaModElements.ModElement {
	public BwtreeStructure(MagicaModElements instance) {
		super(instance, 490);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("magica", "bwtree"));
						if (template == null)
							return false;
