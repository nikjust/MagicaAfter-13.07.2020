...
public class RuneOfPowerOnBlockRightClickedProcedure extends MagicaModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((new ItemStack(Blocks.EMERALD_BLOCK, (int) (1))
			...
			if ((world.getEntitiesWithinAABB(VillagerEntity.class, new AxisAlignedBB(x - 2, y - 2, z - 2, x + 2, y + 2, z + 2), null).stream()
					.sorted(Comparator.comparing(_ent -> _ent.getDistanceSq(x, y, z))).findFirst().orElse(null)) instanceof LivingEntity)
				((LivingEntity) (world.getEntitiesWithinAABB(VillagerEntity.class, new AxisAlignedBB(x - 2, y - 2, z - 2, x + 2, y + 2, z + 2), null)
			...
			if (!world.isRemote && world.getServer() != null) {
				Optional<FunctionObject> _fopt = world.getServer().getFunctionManager().get(new ResourceLocation("minecraft:treaschest"));
				if (_fopt.isPresent()) {
