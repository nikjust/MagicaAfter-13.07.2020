...
public class AmuletOfSalvationRightClickedInAirProcedure extends MagicaModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure AmuletOfSalvationRightClickedInAir!");
			return;
		}
		...
		if ((entity.isSneaking())) {
			if (entity instanceof PlayerEntity)
				((PlayerEntity) entity).inventory
						.clearMatchingItems(p -> new ItemStack(AmuletOfSalvationItem.block, (int) (1)).getItem() == p.getItem(), (int) 1);
			if (entity instanceof PlayerEntity) {
				ItemStack _setstack = new ItemStack(AmuletOfSalvationActiveItem.block, (int) (1));
