...
public class SpitProcedure extends MagicaModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (!world.isRemote) {
			Entity entityToSpawn = new DragonFireballEntity(EntityType.DRAGON_FIREBALL, world);
			entityToSpawn.setLocationAndAngles(x, y, z,
					(float) ((world.getEntitiesWithinAABB(PlayerEntity.class, new AxisAlignedBB(x - 2, y - 2, z - 2, x + 2, y + 2, z + 2), null)
			...
			entityToSpawn.setMotion(
					((world.getEntitiesWithinAABB(PlayerEntity.class, new AxisAlignedBB(x - 2, y - 2, z - 2, x + 2, y + 2, z + 2), null).stream()
							.sorted(Comparator.comparing(_ent -> _ent.getDistanceSq(x, y, z))).findFirst().orElse(null)).getMotion().getX()),
					0, ((world.getEntitiesWithinAABB(PlayerEntity.class, new AxisAlignedBB(x - 2, y - 2, z - 2, x + 2, y + 2, z + 2), null).stream()
