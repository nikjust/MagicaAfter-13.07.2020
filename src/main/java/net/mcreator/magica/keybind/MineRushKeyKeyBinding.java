...
import net.mcreator.magica.procedures.MineRushProcedure;
...
public class MineRushKeyKeyBinding extends MagicaModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.mine_rush_key", GLFW.GLFW_KEY_U, "key.categories.gameplay");
		...
		if (type == 0) {
			{
				...
				MineRushProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
