...
import net.mcreator.magica.procedures.TracerEyeOnKeyPressedProcedure;
...
public class TracerEyeKeyBinding extends MagicaModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public TracerEyeKeyBinding(MagicaModElements instance) {
		super(instance, 467);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.tracer_eye", GLFW.GLFW_KEY_C, "key.categories.magica");
		...
		if (type == 0) {
			{
				...
				TracerEyeOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
