...
import net.mcreator.magica.procedures.SpitProcedure;
...
public class SpitKeybindKeyBinding extends MagicaModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.spit_keybind", GLFW.GLFW_KEY_H, "key.categories.gameplay");
		...
		if (type == 0) {
			{
				...
				SpitProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
