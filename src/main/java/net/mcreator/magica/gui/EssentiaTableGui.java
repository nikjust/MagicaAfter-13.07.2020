...
public class EssentiaTableGui extends MagicaModElements.ModElement {
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			...
			this.font.drawString("" + ((int) entity.getPersistentData().getDouble("ignis")) + "", 65, 185, -6750208);
			this.font.drawString("" + ((int) entity.getPersistentData().getDouble("aqua")) + "", 65, 23, -16776961);
			this.font.drawString("" + ((int) entity.getPersistentData().getDouble("terra")) + "", 2, 86, -10066432);
			this.font.drawString("" + ((int) entity.getPersistentData().getDouble("vita")) + "", 191, 86, -16724941);
		}
