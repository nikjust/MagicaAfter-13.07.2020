...
import net.mcreator.magica.procedures.ResToVitaProcedure;
import net.mcreator.magica.procedures.ResToTerraProcedure;
import net.mcreator.magica.procedures.ResToIgnisProcedure;
import net.mcreator.magica.procedures.ResToAquaProcedure;
...
public class TransmutationTableGui extends MagicaModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public TransmutationTableGui(MagicaModElements instance) {
		super(instance, 275);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("transmutation_table"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("magica:textures/transmutation_table.png");
		@Override
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + -2, this.guiTop + 146, 50, 20, "ignis", e -> {
		...
		if (buttonID == 0) {
			{
				...
				ResToIgnisProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				ResToAquaProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 2) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				ResToVitaProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 3) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				ResToTerraProcedure.executeProcedure($_dependencies);
			}
		}
	}
