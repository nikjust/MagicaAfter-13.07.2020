...
import net.mcreator.magica.procedures.URItemProcedure;
import net.mcreator.magica.procedures.RenameProcedure;
...
public class UltimateRenamerGUIGui extends MagicaModElements.ModElement {
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("ultimate_renamer_gui"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("magica:textures/ultimate_renamer_gui.png");
		@Override
		...
		if (buttonID == 0) {
			{
				...
				RenameProcedure.executeProcedure($_dependencies);
			}
		}
	}
		...
		if (slotID == 0 && changeType == 0) {
			{
				...
				URItemProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
