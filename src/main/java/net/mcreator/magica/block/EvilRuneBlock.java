...
import net.mcreator.magica.procedures.EvilRuneEntityWalksOnTheBlockProcedure;
...
public class EvilRuneBlock extends MagicaModElements.ModElement {
	@ObjectHolder("magica:evil_rune")
	public static final Block block = null;
	public EvilRuneBlock(MagicaModElements instance) {
		super(instance, 74);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				EvilRuneEntityWalksOnTheBlockProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
