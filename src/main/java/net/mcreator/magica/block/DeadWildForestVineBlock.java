...
public class DeadWildForestVineBlock extends MagicaModElements.ModElement {
	@ObjectHolder("magica:dead_wild_forest_vine")
	public static final Block block = null;
	public DeadWildForestVineBlock(MagicaModElements instance) {
		super(instance, 244);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_wild_forest_vine");
		}
