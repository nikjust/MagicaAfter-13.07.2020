...
public class BlackWoodFenceGateBlock extends MagicaModElements.ModElement {
	@ObjectHolder("magica:black_wood_fence_gate")
	public static final Block block = null;
	public BlackWoodFenceGateBlock(MagicaModElements instance) {
		super(instance, 481);
	}
