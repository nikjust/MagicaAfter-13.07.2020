...
public class BurnedStoneBlock extends MagicaModElements.ModElement {
	@ObjectHolder("magica:burned_stone")
	public static final Block block = null;
	public BurnedStoneBlock(MagicaModElements instance) {
		super(instance, 90);
	}
