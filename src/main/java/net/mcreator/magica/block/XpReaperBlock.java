...
import net.mcreator.magica.procedures.XpReaperOnBlockRightClickedProcedure;
...
public class XpReaperBlock extends MagicaModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			Direction direction = hit.getFace();
			{
				...
				XpReaperOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
			return true;
		}
	}
