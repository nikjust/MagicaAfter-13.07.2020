...
public class BlackWoodFenceBlock extends MagicaModElements.ModElement {
	@ObjectHolder("magica:black_wood_fence")
	public static final Block block = null;
	public BlackWoodFenceBlock(MagicaModElements instance) {
		super(instance, 480);
	}
