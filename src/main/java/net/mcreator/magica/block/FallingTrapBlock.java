...
public class FallingTrapBlock extends MagicaModElements.ModElement {
	@ObjectHolder("magica:falling_trap")
	public static final Block block = null;
	public FallingTrapBlock(MagicaModElements instance) {
		super(instance, 464);
	}
