...
public class BlackWoodLeavesBlock extends MagicaModElements.ModElement {
	@ObjectHolder("magica:black_wood_leaves")
	public static final Block block = null;
	public BlackWoodLeavesBlock(MagicaModElements instance) {
		super(instance, 477);
	}
