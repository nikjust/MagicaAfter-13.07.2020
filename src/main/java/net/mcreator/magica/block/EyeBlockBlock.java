...
import net.mcreator.magica.procedures.EyeBlockOnBlockRightClickedProcedure;
...
public class EyeBlockBlock extends MagicaModElements.ModElement {
	@ObjectHolder("magica:eye_block")
	public static final Block block = null;
	public EyeBlockBlock(MagicaModElements instance) {
		super(instance, 87);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			Direction direction = hit.getFace();
			{
				...
				EyeBlockOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
			return true;
		}
	}
