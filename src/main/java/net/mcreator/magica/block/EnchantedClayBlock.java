...
import net.mcreator.magica.procedures.EnchantedClayOnBlockRightClickedProcedure;
...
public class EnchantedClayBlock extends MagicaModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("enchanted_clay");
		}
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			Direction direction = hit.getFace();
			{
				...
				EnchantedClayOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
			return true;
		}
	}
