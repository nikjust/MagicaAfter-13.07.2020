...
import net.mcreator.magica.procedures.EssentiaTableBlockOnBlockRightClickedProcedure;
...
public class EssentiaTableBlockBlock extends MagicaModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("essentia_table_block");
		}
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			Direction direction = hit.getFace();
			{
				...
				EssentiaTableBlockOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
			return true;
		}
	}
