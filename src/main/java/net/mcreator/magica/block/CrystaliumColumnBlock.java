...
import net.mcreator.magica.procedures.CrystaliumColumnBlockAddedProcedure;
...
public class CrystaliumColumnBlock extends MagicaModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crystalium_column");
		}
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			int z = pos.getZ();
			{
				...
				CrystaliumColumnBlockAddedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
