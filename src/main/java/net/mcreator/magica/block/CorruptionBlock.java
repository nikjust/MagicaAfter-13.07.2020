...
import net.mcreator.magica.procedures.CorruptionUpdateTickProcedure;
...
public class CorruptionBlock extends MagicaModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, World world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				CorruptionUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
	}
