...
import net.mcreator.magica.procedures.HyperTowerRuneBlockDestroyedByExplosionProcedure;
import net.mcreator.magica.procedures.HyperTowerRuneBlockAddedProcedure;
...
public class HyperTowerRuneBlock extends MagicaModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hyper_tower_rune");
		}
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			int z = pos.getZ();
			{
				...
				HyperTowerRuneBlockAddedProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				HyperTowerRuneBlockDestroyedByExplosionProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
