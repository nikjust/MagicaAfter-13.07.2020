...
import net.mcreator.magica.procedures.RuneOfPowerOnBlockRightClickedProcedure;
...
public class RuneOfPowerBlock extends MagicaModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			Direction direction = hit.getFace();
			{
				...
				RuneOfPowerOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
			return true;
		}
	}
