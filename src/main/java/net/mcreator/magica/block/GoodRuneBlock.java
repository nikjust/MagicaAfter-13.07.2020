...
import net.mcreator.magica.procedures.GoodRuneEntityWalksOnTheBlockProcedure;
...
public class GoodRuneBlock extends MagicaModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				GoodRuneEntityWalksOnTheBlockProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
